...
Window::Window(uint16_t width, uint16_t height, std::string title)
  ...
  void Window::mouseButtonCallback(GLFWwindow* window, int button, int action, [[maybe_unused]] int mods) {
  ...
  void Window::keyboardButtonCallback(GLFWwindow* window, int button, [[maybe_unused]] int scancode, int action, [[maybe_unused]] int mods) {
