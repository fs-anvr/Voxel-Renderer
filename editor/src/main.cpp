    ...
    void Update() override {
      ...
      if (VoxelEngine::Input::IsPressed(VoxelEngine::KeyCode::MOUSE_RIGHT_BUTTON)) {
        VoxelEngine::ServiceLocator::Camera().RotateForAngle(
          cameraRotateSpeed * deltaTime * VoxelEngine::Input::Mouse::GetDeltaPos().first,
          cameraRotateSpeed * deltaTime * VoxelEngine::Input::Mouse::GetDeltaPos().second
        );
      ...
      if (VoxelEngine::Input::IsPressed(VoxelEngine::KeyCode::KEYBOARD_UPARROW) || VoxelEngine::Input::IsRepeated(VoxelEngine::KeyCode::KEYBOARD_UPARROW)) {
        VoxelEngine::ServiceLocator::Camera().MoveFor(cameraSpeed * deltaTime, 0.0, 0.0);
      }
      if (VoxelEngine::Input::IsPressed(VoxelEngine::KeyCode::KEYBOARD_DOWNARROW) || VoxelEngine::Input::IsRepeated(VoxelEngine::KeyCode::KEYBOARD_DOWNARROW)) {
        VoxelEngine::ServiceLocator::Camera().MoveFor(-cameraSpeed * deltaTime, 0.0, 0.0);
      }
      if (VoxelEngine::Input::IsPressed(VoxelEngine::KeyCode::KEYBOARD_RIGHTARROW) || VoxelEngine::Input::IsRepeated(VoxelEngine::KeyCode::KEYBOARD_RIGHTARROW)) {
        VoxelEngine::ServiceLocator::Camera().MoveFor(0.0, cameraSpeed * deltaTime, 0.0);
      }
      if (VoxelEngine::Input::IsPressed(VoxelEngine::KeyCode::KEYBOARD_LEFTARROW) || VoxelEngine::Input::IsRepeated(VoxelEngine::KeyCode::KEYBOARD_LEFTARROW)) {
        VoxelEngine::ServiceLocator::Camera().MoveFor(0.0, -cameraSpeed * deltaTime, 0.0);
      }
    }
};
